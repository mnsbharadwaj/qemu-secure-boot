...
# --------------------------------------------
# RECONSTRUCT PUBLIC KEY FROM Qx and Qy
# --------------------------------------------

Qx = int.from_bytes(Q_bin[:48], "big")
Qy = int.from_bytes(Q_bin[48:], "big")
...
try:
    pub.verify(sig, message, ec.ECDSA(hashes.SHA384()))

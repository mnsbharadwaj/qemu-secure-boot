...
{
    printf("\n===============================================\n");
    printf("  FULL ECDSA SECp384r1 VERIFICATION COMPARISON\n");
    printf("   OpenSSL | Manual | FW Pipeline | All Steps\n");
    printf("===============================================\n\n");
    ...
    /* ===============================
     * SECTION 1 — OpenSSL verification
     * =============================== */
    printf("\n============================\n");
    printf(" 1) OpenSSL reference check\n");
    printf("============================\n");
     ...
     * =============================== */
    printf("\n============================\n");
    printf(" 2) Manual textbook algorithm\n");
    printf("============================\n");
    ...
    print_bn("u1 = e*w_inv mod n", u1);
    print_bn("u2 = r*w_inv mod n", u2);
     ...
     * =============================== */
    printf("\n============================\n");
    printf(" 3) FW-style custom algorithm\n");
    printf("============================\n");
    ...
    print_bn("u1_fw = e*w_fw mod n", u1_fw);
    print_bn("u2_fw = r*w_fw mod n", u2_fw);

    /* Compute R over field p */
    ...
    print_bn("Rx_fw", Rx_fw);

    /* Montgomery contexts for p,n */
    BIGNUM *p = BN_new();
    BIGNUM *a = BN_new();
    BIGNUM *b = BN_new();
